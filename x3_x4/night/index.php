...
<!-- End Google Tag Manager (noscript) -->
	...
	<div class="container">
		<div class="title1_container">
			<div class="title1">ТОЛЬКО ЭТОЙ НОЧЬЮ</div>
			<div class="title1_comment">РАЗГОНЯЕМСЯ ДО 500 000 Р. И БОЛЬШЕ.<br/> Не проспи свой шанс</div>
			<a class="btn popup arrow" href="#form_popup" _comment="" _name="vizov" _title="ПОЛУЧИТЬ ИНДИВИДУАЛЬНОЕ ПРЕДЛОЖЕНИЕ"><span>ПОЛУЧИТЬ ИНДИВИДУАЛЬНОЕ ПРЕДЛОЖЕНИЕ</span></a>
		</div>
	</div>
	<div class="container">
		<div class="contacts">
			...
			<div class="column">
				<strong class="type2">ЧАСЫ РАБОТЫ:</strong>
