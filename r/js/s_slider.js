jQuery.fn.simpleslider = function( options )
{
	...
	var methods =
	{
		...
		//		console.log(methods.s_container_width);
		//		console.log(settings.init_bullet);
		...
		__init_bullets: function()
		{
			$('.s_item',settings._this).each(function()
			{
				...
				if (settings.init_bullet == true) $('.bullet',settings._this).append('<span></span>');
				$(this).attr('num',$num);
			});
